...
(function(factory) {
    ...
    var DataTable = function(options) {
        ...
        this.each(function() {
            ...
            for (i = 0,
            iLen = allSettings.length; i < iLen; i++) {
                var s = allSettings[i];
            ...
            /* Add the columns */
            for (i = 0,
            iLen = aoColumnsInit.length; i < iLen; i++) {
    ...
    function _fnColumnTypes(settings) {
        ...
        ien = columns.length; i < ien; i++) {
            ...
            if (!col.sType && col._sManualType) {
                ...
                for (j = 0,
                jen = types.length; j < jen; j++) {
                    for (k = 0,
                    ken = data.length; k < ken; k++) {
    ...
    function _fnDrawHead(oSettings, aoSource, bIncludeHidden) {
        ...
        iLen = aoLocal.length; i < iLen; i++) {
            ...
            for (j = 0,
            jLen = aoLocal[i].length; j < jLen; j++) {
                iRowspan = 1;
                iColspan = 1;
    ...
    function _fnFeatureHtmlFilter(settings) {
        ...
        filter.find('label').addClass(classes.sFilterLabel);
    ...
    function _fnFeatureHtmlLength(settings) {
        ...
        div.find('label').addClass(classes.sFilterSelect);
    ...
    function _fnSortFlatten(settings) {
        ...
        for (i = 0; i < nestedSort.length; i++) {
            ...
            for (k = 0,
            kLen = aDataSort.length; k < kLen; k++) {
                iCol = aDataSort[k];
    ...
    function _fnSort(oSettings) {
        ...
        if (_fnDataSource(oSettings) != 'ssp' && aSort.length !== 0) {
            ...
            for (i = 0,
            iLen = displayMaster.length; i < iLen; i++) {
        ...
        if (append && settings.oFeatures.bSortMulti) {
            ...
            if (sortIdx !== -1) {
                ...
                if (nextSortIdx === null && sorting.length === 1) {
                    nextSortIdx = 0;
                    // can't remove sorting completely
                }
    ...
    function _fnLoadState(settings, oInit) {
        ...
        // Columns
        for (i = 0,
        ien = state.columns.length; i < ien; i++) {
    ...
    var _selector_row_indexes = function(settings, opts) {
        ...
        if (_fnDataSource(settings) == 'ssp') {
            ...
            // are
            for (i = settings._iDisplayStart,
            ien = settings.fnDisplayEnd(); i < ien; i++) {
