...
;(function($, window, document, undefined) {
  ...
  ================================================== */
    tracking = {
        ...
        digg: function() {//if somenone find a solution, mail me !
        ...
        pinterest: function() {//if somenone find a solution, mail me !
        }
    }
  ...
  ================================================== */
    function Plugin(element, options) {
        ...
        //simple solution to allow order of buttons
        ...
        if (url != '' && self.options.urlCurl !== '') {
            ...
            $.getJSON(url, function(json) {
                if (typeof json.count !== "undefined") {
                    ...
                    var temp = json.count + '';
                    temp = temp.replace('\u00c2\u00a0', '');
                    //remove google plus special chars
